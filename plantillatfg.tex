...
\section{Arquitectura de la FPGA}
  ...
  Como se ha mencionado antes la FPGA esta compuesta por varios componentes a
  ...
  \subsection{Cofigurable Logic Block}
      ...
      \begin{itemize}
         \item \textbf{Look-up tables:} Esta determina una salida a partir de una tabla y
         ...
         necesarias.  
         \item \textbf{Full adder:} %//TODO Full Adder
         
         \item \textbf{Flip-Flop tipo D:} De toda la familia existente de los biestables,
   ...
   \subsection{ASIC}
     ...
     propositos generales. Como arquitectura encontramos varias de ellas:
      ...
      \begin{itemize}
         ...
         \item \textbf{Dise\~{n}o basado en Celdas Estándares:} El diseño ASIC basado en
...
%//TODO Dar a entender los pros de la FPGA en la actualidad
   Cuando hablamos de FPGA, podemos destacamos ciertas caracteristicas y las
   comparamos con otras arquitecturas para llegar a saber cual nos interesa mas
   para el problema a tratar. Algunos de los detalles a comparar con otras
   arquitecturas, las cuales hemos detallado anteriormente son:

   \subsection{Rendimiento}
      A terminos de rendimiento, esto siempre dependera de la problematica a
      ...
      la FPGA o el ASIC y por tanto podran ejecutar estas funciones más rapido.
      ...
      a rendimiento los diseños de ASIC y FPGA seran mas rapido, ya que la GPU
      dependera sustancialmente de la CPU. Y en cuanto a mayor rendimiento entre
      la tecnologia ASIC y FPGA, la tecnologia ASIC mostrara mejor rendimiento,
      ya que la FPGA sacrifica un poco de este a cambio de otras caracteristicas
...
\section{HLS vs RTL}
\section{Lenguajes de descripcion}
   \subsection{Verilog}
   \subsection{VHDL}
