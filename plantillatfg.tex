...
\section{Comparativa de flujo de dise\~{n}o}
   ...
   \subsection{Coste/Eficiencia}
      ...
      En esta caracteristica, la tecnologia HLS sale ganadora, por su reduccion
      de fundamentos a una simple guia de metodologias y tambien a la
      adaptabilidad hacia al problema, haciendo que el tiempo usado para ello
      sea menor que en lenguajes HDL, los cuales hay la necesidad de aprender
      ciertos fundamentos sobre el diseño digital y ademas sobre el lenguaje a
      utilizar.
\newpage
\section{Conclusion}
