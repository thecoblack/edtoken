...
\chapter{Configuracion y ''Workflow'' en tecnologias FPGA}
   ...
   Como se ha mencionado en otros apartados el diseño en tecnologias FPGA
   sigue siendo costoso y complejo por su forma de tratar con la
   arquitectura, la forma tradicional de tratar de esta es mediante leguajes de
   diseño RTL como Verilog o VHDL que permite diseñar la logica en bloques
   logicos.

   Estos bloques estrito en algun lenguaje RTL son pequeñas microarquitecturas
   configuradas para tener sus propias entradas como inputs o entradas de reloj
   y salidas. 
...
\section{Lenguajes de descripción}
   ...
   \subsection{Ventajas de los lenguajes HDL}


   
   \subsection {Metodologia de diseño}
...
\section{High Level Synthesis}
   ...
   de acciones, que dependiendo de la HLS usado, siguen un orden usadon
   diferentes algoritmos y asi obtener el resultado deseado. Estas actividades son: 

   \begin{itemize}
      \item \textbf{Procesamiento lexico: } 
      \item \textbf{Optimizacion del algoritmo: }
      \item \textbf{Analisis de control/flujo de datos: }
      \item \textbf{Procesamiento de librerias: }
      \item \textbf{Asignación de recursos: }
      \item \textbf{Planificación: }
      \item \textbf{Enlace de la unidad funcional: }
      \item \textbf{Enlace de registro: }
      \item \textbf{Procesamiento de salida: }
      \item \textbf{Reagrupación de entrada: }
   \end{itemize}

   \subsection{Metodologia de dise\~{n}o}
