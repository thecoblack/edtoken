...
\section{Arquitecturas heterogenias}
   ...
   \subsection{CPU}
      Actualmente esta es la arquitectura mas conocida y la mas antigua de todas las
      que comentaremos. Su trabajo principalmente es la coordinacion de los diferentes
      elementos que conforman actualmente una computadora. Encontramos varios tipos dependiendo,
      del mercado al que vayan destinado y se componen por un unico circuito integrado o varios
      CPU's en un mismo circuito como es el caso de los procesadores multinucleo.

      Este funciona a base de la interpretacion de intrucciones, para realizar las diferentes 
      acciones ya sean, operaciones aritmeticas, manipurlacion de registros, deconficacion de estas
      mismas intrucciones etc. Cuanto a su arquitectura mas simple, se compone de:
