...
\chapter{Vitis High-Level Synthesis}
   ...
   \section {Interfaz AXI}
      Actualmente la comunicacion entre puertos del RTL generado por el HLS de Xillinx,
      se produce mediante la interfaz AXI. 
      ...
      Dentro de esta interfaz AXI4 la cual corresponde a la version AMBA 4.0,
      encontramos trest tipos:
      \begin{itemize}
         \item \textbf{AXI4}: Esta suele utilizarse en los puertos donde los
         requisitos de asiganacion de la memoria necesita un alto rendimento.
         \item \textbf{AXI4-Lite}
      \end{itemize}
      

      \subsection {Interfaz AXI4-Lite}
      \subsection {Interfaz AXI4 Master}
      \subsection {Interfaz AXI4 Stream}
